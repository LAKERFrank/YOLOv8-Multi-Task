...
from ultralytics_tracknet import RTDETR, YOLO
from ultralytics_tracknet.yolo.data.build import load_inference_source
from ultralytics_tracknet.yolo.utils import LINUX, ONLINE, ROOT, SETTINGS
...
def test_amp():
    if torch.cuda.is_available():
        from ultralytics_tracknet.yolo.utils.checks import check_amp
