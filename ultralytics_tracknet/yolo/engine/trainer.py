...
from ultralytics_tracknet.nn.tasks import attempt_load_one_weight, attempt_load_weights
from ultralytics_tracknet.yolo.cfg import get_cfg
from ultralytics_tracknet.yolo.data.utils import check_cls_dataset, check_det_dataset
from ultralytics_tracknet.yolo.utils import (DEFAULT_CFG, LOGGER, RANK, SETTINGS, TQDM_BAR_FORMAT, __version__, callbacks,
                                    clean_url, colorstr, emojis, yaml_save)
from ultralytics_tracknet.yolo.utils.autobatch import check_train_batch_size
from ultralytics_tracknet.yolo.utils.checks import check_amp, check_file, check_imgsz, print_args
from ultralytics_tracknet.yolo.utils.dist import ddp_cleanup, generate_ddp_command
from ultralytics_tracknet.yolo.utils.files import get_latest_run, increment_path
from ultralytics_tracknet.yolo.utils.torch_utils import (EarlyStopping, ModelEMA, de_parallel, init_seeds, one_cycle,
...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        if RANK in (-1, 0):
            self.test_loader = self.get_dataloader(self.testset, batch_size=1, rank=-1, mode='val')
            ...
            for i, batch in pbar:
                ...
                if RANK in (-1, 0):
                    pbar.set_description(
                        ...
                        (f'{epoch + 1}/{self.epochs}', mem, *losses, batch['img'].shape[-1]))
