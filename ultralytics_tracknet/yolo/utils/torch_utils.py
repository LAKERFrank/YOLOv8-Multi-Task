...
from ultralytics_tracknet.yolo.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, __version__
from ultralytics_tracknet.yolo.utils.checks import check_requirements, check_version
...
def model_info_for_loggers(trainer):
    ...
    if trainer.args.profile:  # profile ONNX and TensorRT times
        from ultralytics_tracknet.yolo.utils.benchmarks import ProfileModels
