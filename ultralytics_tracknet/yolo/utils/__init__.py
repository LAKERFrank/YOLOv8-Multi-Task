...
from ultralytics_tracknet import __version__
...
def get_settings(file=SETTINGS_YAML, version='0.0.3'):
    ...
    from ultralytics_tracknet.yolo.utils.checks import check_version
    from ultralytics_tracknet.yolo.utils.torch_utils import torch_distributed_zero_first
