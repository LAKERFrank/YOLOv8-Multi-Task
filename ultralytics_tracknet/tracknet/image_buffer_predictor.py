...
from ultralytics_tracknet.yolo.utils import DEFAULT_CFG, LOGGER, SETTINGS, callbacks
...
from ultralytics_tracknet.tracknet.protocal.image_buffer import FrameProtocol, ImageBufferProtocol
