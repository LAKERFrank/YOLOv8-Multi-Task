...
game_list = ['match1', 'match2', 'match3', 'match4', 'match5', 'match6', 'match7', 'match8', 'match9', 'match10', 'match11']
p = os.path.join('train_data', game_list[0], 'frame', '1_01_00', '1.png')
...
for game in game_list:
	...
	for p in train_path:
		...
		while ptr < num:
			x_data_tmp = []
			y_data_tmp = []
			while (i < ptr+BATCH_SIZE) and (i < num):
				unit = []
				for j in range(1):
